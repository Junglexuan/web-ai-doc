...
define('vs/basic-languages/bat/bat', ['require', 'require'], (require) => {
  var moduleExports = (() => {
    ...
    var g = (o, e) => {
      ...
      c = (o, e, t, a) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
          for (let s of l(e)) !i.call(o, s) && s !== t && n(o, s, {get: () => e[s], enumerable: !(a = r(e, s)) || a.enumerable});
        return o;
      };
    ...
    var d = {
        ...
        folding: {markers: {start: new RegExp('^\\s*(::\\s*|REM\\s+)#region'), end: new RegExp('^\\s*(::\\s*|REM\\s+)#endregion')}},
      },
      m = {
        defaultToken: '',
        ignoreCase: !0,
