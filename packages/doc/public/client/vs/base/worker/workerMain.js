      ...
      _detect() {
        this._detected ||
          ...
          (this._isElectronRenderer =
            typeof process < 'u' && typeof process.versions < 'u' && typeof process.versions.electron < 'u' && process.type === 'renderer'),
  ...
  (function (q) {
    class n {
      ...
      static recursiveClone(A) {
        if (!A || typeof A != 'object' || A instanceof RegExp || (!Array.isArray(A) && Object.getPrototypeOf(A) !== Object.prototype)) return A;
      ...
      static getHighPerformanceTimestamp() {
        return (
          this.PERFORMANCE_NOW_PROBED ||
            ((this.PERFORMANCE_NOW_PROBED = !0), (this.HAS_PERFORMANCE_NOW = q.global.performance && typeof q.global.performance.now == 'function')),
  ...
  (function (q) {
      ...
      static validateConfigurationOptions(d) {
        ...
        if (
          ...
          d.nodeCachedData &&
            ...
            (typeof d.nodeCachedData.writeDelay != 'number' || d.nodeCachedData.writeDelay < 0) && (d.nodeCachedData.writeDelay = 1e3 * 7),
    ...
    class A {
      ...
      _createSortedPathsRules() {
        (this.sortedPathsRules = []),
          q.Utilities.forEachProperty(this.options.paths, (d, g) => {
            Array.isArray(g) ? this.sortedPathsRules.push({from: d, to: g}) : this.sortedPathsRules.push({from: d, to: [g]});
          }),
      ...
      _addUrlArgsIfNecessaryToUrls(d) {
        if (this.options.urlArgs) for (let g = 0, L = d.length; g < L; g++) d[g] = this._addUrlArgsToUrl(d[g]);
        return d;
      }
      moduleIdToPaths(d) {
        if (this._env.isNode && this.options.amdModulesPattern instanceof RegExp && !this.options.amdModulesPattern.test(d))
        ...
        if (!q.Utilities.endsWith(g, '.js') && !q.Utilities.isAbsolutePath(g)) {
          ...
          for (let h = 0, o = L.length; h < o; h++)
            (this.isBuild() && L[h] === 'empty:') ||
              ...
              !q.Utilities.endsWith(L[h], '.js') && !q.Utilities.containsQueryString(L[h]) && (L[h] = L[h] + '.js'));
        } else !q.Utilities.endsWith(g, '.js') && !q.Utilities.containsQueryString(g) && (g = g + '.js'), (L = [g]);
        return this._addUrlArgsIfNecessaryToUrls(L);
      }
      requireToUrl(d) {
        let g = d;
        return (
          q.Utilities.isAbsolutePath(g) || ((g = this._applyPaths(g)[0]), q.Utilities.isAbsolutePath(g) || (g = this.options.baseUrl + g)),
    ...
    class i {
      ...
      load(o, C, e, a) {
        if (/^node\|/.test(C)) {
          ...
          if (!(/^((http:)|(https:)|(file:))/.test(C) && C.substring(0, self.origin.length) !== self.origin) && this._canUseEval(o)) {
            fetch(C)
              .then((m) => {
...
//# sourceURL=${C}`),
    ...
    class d {
      ...
      _init(o) {
        this._didInitialize ||
          ((this._didInitialize = !0), (this._fs = o('fs')), (this._vm = o('vm')), (this._path = o('path')), (this._crypto = o('crypto')));
      }
      _initNodeRequire(o, C) {
        ...
        u.prototype._compile = function (m, f) {
          ...
          return a._handleCachedData(r, S, E, !y.cachedData, C), a._verifyCachedData(r, S, E, _, C), v;
        };
      }
      load(o, C, e, a) {
        const u = o.getConfig().getOptionsLiteral(),
        ...
        if (/^node\|/.test(C)) {
          ...
          this._readSourceAndCachedData(S, y, f, (_, r, s, l) => {
            ...
            let p;
            r.charCodeAt(0) === d._BOM ? (p = d._PREFIX + r.substring(1) + d._SUFFIX) : (p = d._PREFIX + r + d._SUFFIX), (p = m(p, S));
      ...
      _getElectronRendererScriptPathOrUri(o) {
        ...
        let C = o.match(/^([a-z])\:(.*)/i);
        return C ? `file:///${(C[1].toUpperCase() + ':' + C[2]).replace(/\\/g, '/')}` : `file://${o}`;
      }
      _getCachedDataPath(o, C) {
        const e = this._crypto.createHash('md5').update(C, 'utf8').update(o.seed, 'utf8').update(process.arch, '').digest('hex'),
      ...
      _handleCachedData(o, C, e, a, u) {
        o.cachedDataRejected
          ? this._fs.unlink(e, (c) => {
              u.getRecorder().record(62, e), this._createAndWriteCachedData(o, C, e, u), c && u.getConfig().onError(c);
            })
        ...
        if (!C) this._fs.readFile(o, {encoding: 'utf8'}, a);
          ...
          this._fs.readFile(o, {encoding: 'utf8'}, (w, E) => {
            ...
            this._fs.readFile(C, (w, E) => {
              !w && E && E.length > 0 ? ((m = E.slice(0, 16)), (c = E.slice(16)), e.record(60, C)) : e.record(61, C), S();
            });
        }
      }
        ...
        a &&
          (o.cachedDataRejected ||
            setTimeout(() => {
              ...
              a.equals(c) ||
                (u.getConfig().onError(new Error(`FAILED TO VERIFY CACHED DATA, deleting stale '${e}' now, but a RESTART IS REQUIRED`)),
                this._fs.unlink(e, (m) => {
  ...
  (function (q) {
      ...
      resolveModule(h) {
        ...
        return (
          q.Utilities.isAbsolutePath(o) ||
            ((q.Utilities.startsWith(o, './') || q.Utilities.startsWith(o, '../')) && (o = n._normalizeModuleId(this.fromModulePath + o))),
          o
        );
      }
    }
        ...
        if (this._callback)
          if (typeof this._callback == 'function') {
            ...
            (a = u.producedError),
              ...
              !a && typeof u.returnedValue < 'u' && (!this.exportsPassedIn || q.Utilities.isEmpty(this.exports)) && (this.exports = u.returnedValue);
    ...
    class A {
      ...
      getModuleId(h) {
        ...
        return typeof o > 'u' && ((o = this._nextId++), this._strModuleIdToIntModuleId.set(h, o), (this._intModuleIdToStrModuleId[o] = h)), o;
      }
      getStrModuleId(h) {
    ...
    class g {
      ...
      reset() {
        return new g(this._env, this._scriptLoader, this._defineFunc, this._requireFunc, this._loaderAvailableTimestamp);
      }
      ...
      defineModule(h, o, C, e, a, u = new n(h)) {
        ...
        (this._modules2[c] = m),
          this._config.isBuild() &&
            ...
            (this._buildInfoDependencies[c] = (m.dependencies || []).map((f) => this._moduleIdProvider.getStrModuleId(f.id)))),
          this._resolve(m);
      }
      ...
      synchronousRequire(h, o = new n(h)) {
        ...
        if (!e)
          throw new Error("Check dependency list! Synchronous require cannot resolve module '" + h + "'. This is the first mention of this module!");
        if (!e.isComplete())
          throw new Error(
            "Check dependency list! Synchronous require cannot resolve module '" + h + "'. This module has not been resolved completely yet."
          );
      ...
      _onLoadError(h, o) {
        ...
        this._modules2[h] || (this._modules2[h] = new M(h, this._moduleIdProvider.getStrModuleId(h), [], () => {}, null, null));
        let e = [];
          ...
          u = (c) => {
            if ((a++, a >= C.length)) this._onLoadError(h, c);
              ...
              if (this._config.isBuild() && m === 'empty:') {
                (this._buildInfoPath[h] = m), this.defineModule(this._moduleIdProvider.getStrModuleId(h), [], null, null, null), this._onLoad(h);
                return;
              }
              f.record(10, m),
                this._scriptLoader.load(
...
`)
            ...
            if (
              ...
              m || ((m = []), this._inversePluginDependencies2.set(a.pluginId, m)), m.push(a), this._loadModule(a.pluginId);
              continue;
            }
    ...
    X(J[19], Z([0, 1]), function (q, n) {
        ...
        return (
          S.length === 0
            ...
            : (w = f.replace(/\{(\d+)\}/g, (E, y) => {
                ...
                let s = E;
                return (
                  typeof r == 'string' ? (s = r) : (typeof r == 'number' || typeof r == 'boolean' || r === void 0 || r === null) && (s = String(r)), s
                );
              })),
      ...
      function c(f, S) {
        ...
        return {
          localize: h(S[f]),
          localize2: o(S[f]),
          getConfiguredDefaultLocale: (w = S.getConfiguredDefaultLocale) !== null && w !== void 0 ? w : (E) => {},
        };
      }
      n.create = c;
      function m(f, S, w, E) {
        ...
        s || (l = l + '.' + r);
        const p = (b) => {
          Array.isArray(b) ? ((b.localize = h(b)), (b.localize2 = o(b))) : ((b.localize = h(b[f])), (b.localize2 = o(b[f]))),
        ...
        typeof _.loadBundle == 'function'
          ...
          ? (async () => {
              ...
              try {
                ...
                try {
                  ...
                  return ((b = _.availableLanguages) !== null && b !== void 0) || (_.availableLanguages = {}), (_.availableLanguages['*'] = R), p(N);
                } catch (R) {
          ...
          : S([f + l], p, (b) => {
              ...
              console.error(`Failed to load message bundle for language ${r}. Falling back to the default language:`, b), S([f + '.nls'], p);
            });
      }
      n.load = m;
    }),
    (function () {
      ...
      function d() {
        return new Promise((C, e) => {
          ...
          if (!(/^((http:)|(https:)|(file:))/.test(a) && a.substring(0, globalThis.origin.length) !== globalThis.origin) && i()) {
            fetch(a)
              .then((c) => {
...
//# sourceURL=${a}`),
    ...
    X(J[7], Z([0, 1]), function (q, n) {
      ...
      function h(k, O, I) {
        ...
        return k < H.length ? h(k, H, I) : k < H.length + t.length ? t[0] : h(k - (H.length + t.length), Y, I);
      }
      n.quickSelect = h;
      function o(k, O) {
        const I = [];
        let V;
        for (const H of k.slice(0).sort(O)) !V || O(V[0], H) !== 0 ? ((V = [H]), I.push(V)) : V.push(H);
        return I;
      }
      n.groupBy = o;
      function* C(k, O) {
        let I, V;
        for (const H of k) V !== void 0 && O(V, H) ? I.push(H) : (I && (yield I), (I = [H])), (V = H);
        I && (yield I);
      }
      n.groupAdjacentBy = C;
      function e(k, O) {
      ...
      (function (k) {
        ...
        (k.isNeitherLessOrGreaterThan = H), (k.greaterThan = 1), (k.lessThan = -1), (k.neitherLessOrGreaterThan = 0);
      })(R || (n.CompareResult = R = {}));
      function N(k, O) {
      ...
      class z {
        ...
        findLastMaxBy(O) {
          let I,
            V = !0;
          return this.iterate((H) => ((V || R.isGreaterThan(O(H, I))) && ((V = !1), (I = H)), !0)), I;
        }
      }
    ...
    X(J[32], Z([0, 1]), function (q, n) {
      ...
      class M {
        ...
        get(d) {
          ...
          return this.lastArgKey !== g && ((this.lastArgKey = g), (this.lastCache = this.fn(d))), this.lastCache;
        }
      }
    ...
    X(J[33], Z([0, 1]), function (q, n) {
      ...
      class i {
        ...
        static _hue2rgb(h, o, C) {
          return (
            C < 0 && (C += 1), C > 1 && (C -= 1), C < 1 / 6 ? h + (o - h) * 6 * C : C < 1 / 2 ? o : C < 2 / 3 ? h + (o - h) * (2 / 3 - C) * 6 : h
          );
        }
        static toRGBA(h) {
          const o = h.h / 360,
          ...
          if (C === 0) u = c = m = e;
            ...
            const f = e < 0.5 ? e * (1 + C) : e + C - e * C,
              S = 2 * e - f;
            (u = i._hue2rgb(S, f, o + 1 / 3)), (c = i._hue2rgb(S, f, o)), (m = i._hue2rgb(S, f, o - 1 / 3));
          }
      ...
      class d {
        ...
        static fromRGBA(h) {
          ...
          let f;
          return (
            c === 0 ? (f = 0) : a === o ? (f = ((((C - e) / c) % 6) + 6) % 6) : a === C ? (f = (e - o) / c + 2) : (f = (o - C) / c + 4),
      ...
      class g {
        ...
        makeOpaque(h) {
          ...
          const {r: o, g: C, b: e, a} = this.rgba;
          return new g(new A(h.rgba.r - a * (h.rgba.r - o), h.rgba.g - a * (h.rgba.g - C), h.rgba.b - a * (h.rgba.b - e), 1));
        }
        toString() {
      ...
      (n.Color = g),
        ...
        (function (L) {
          ...
          (function (o) {
            ...
            (function (e) {
              function a(r) {
                return r.rgba.a === 1 ? `rgb(${r.rgba.r}, ${r.rgba.g}, ${r.rgba.b})` : L.Format.CSS.formatRGBA(r);
              }
              e.formatRGB = a;
              function u(r) {
    ...
    X(J[34], Z([0, 1]), function (q, n) {
      ...
      class M {
        constructor(i, d, g, L) {
          (this.originalStart = i), (this.originalLength = d), (this.modifiedStart = g), (this.modifiedLength = L);
        }
        getOriginalEnd() {
...
` +
      ...
      function d(m) {
        if (m instanceof Error) {
          ...
          return {$isError: !0, name: f, message: S, stack: w, noTelemetry: u.isErrorNoTelemetry(m)};
        }
        return m;
      }
    ...
    X(J[12], Z([0, 1, 5]), function (q, n, M) {
      'use strict';
      Object.defineProperty(n, '__esModule', {value: !0}), (n.checkAdjacentItems = n.assertFn = n.assertNever = n.ok = void 0);
      function A(L, h) {
    ...
    X(J[21], Z([0, 1]), function (q, n) {
      ...
      (function (A) {
        ...
        function* E(_, r, s = _.length) {
          for (r < 0 && (r += _.length), s < 0 ? (s += _.length) : s > _.length && (s = _.length); r < s; r++) yield _[r];
        }
        A.slice = E;
          ...
          if (
            (c[S] ||
              ...
              f &&
                ...
                E !== 0 && E !== 3 && E !== 5 && E !== 4 && E !== 6 && E !== 57 && (n.IMMUTABLE_KEY_CODE_TO_CODE[E] = S))),
            !u[E])
          ) {
            if (((u[E] = !0), !y)) throw new Error(`String representation missing for key code ${E} around scan code ${w}`);
    ...
    X(J[13], Z([0, 1, 20, 21]), function (q, n, M, A) {
      ...
      class w {
        ...
        set value(s) {
          var l;
          this._isDisposed || s === this._value || ((l = this._value) === null || l === void 0 || l.dispose(), s && o(s, this), (this._value = s));
        }
        clear() {
          this.value = void 0;
        }
        dispose() {
          var s;
          (this._isDisposed = !0), h(this), (s = this._value) === null || s === void 0 || s.dispose(), (this._value = void 0);
        }
      }
    ...
    X(J[37], Z([0, 1]), function (q, n) {
      ...
      class g {
        constructor(a, u) {
          if (((this[M] = 'ResourceMap'), a instanceof g)) (this.map = new Map(a.map)), (this.toKey = u ?? g.defaultToKey);
          else if (d(a)) {
      ...
      class L {
        constructor() {
          (this[A] = 'LinkedMap'), (this._map = new Map()), (this._head = void 0), (this._tail = void 0), (this._size = 0), (this._state = 0);
        }
        clear() {
            ...
            onWillAddFirstListener() {
              B = K((ce) => {
                te++,
                  ...
                  typeof G == 'number' ? (clearTimeout($), ($ = setTimeout(ie, G))) : $ === void 0 && (($ = 0), queueMicrotask(ie));
              });
            },
      ...
      class a {
        ...
        check(v, R) {
          ...
          if ((this._stacks.set(v.value, D + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)) {
            ...
            console.warn(`[${this.name}] potential listener LEAK detected, having ${R} listeners already. MOST frequent listener (${T}):`),
              console.warn(x);
          }
          return () => {
...
`)
      ...
      class S {
          ...
          (this._size = 0),
            ...
            (this._leakageMon =
              e > 0 || (!((R = this._options) === null || R === void 0) && R.leakWarningThreshold)
                ? new a((D = (N = this._options) === null || N === void 0 ? void 0 : N.leakWarningThreshold) !== null && D !== void 0 ? D : e)
                : void 0),
            (this._perfMon = !((x = this._options) === null || x === void 0) && x._profName ? new C(this._options._profName) : void 0),
        ...
        dispose() {
          ...
          if (!this._disposed) {
            if (
              ((this._disposed = !0),
              ((v = this._deliveryQueue) === null || v === void 0 ? void 0 : v.current) === this && this._deliveryQueue.reset(),
              this._listeners)
            ) {
              if (L) {
            ...
            (N = (R = this._options) === null || R === void 0 ? void 0 : R.onDidRemoveLastListener) === null || N === void 0 || N.call(R),
          ...
          return (
            ((v = this._event) !== null && v !== void 0) ||
              (this._event = (R, N, D) => {
                ...
                this._leakageMon &&
                  ...
                  this._listeners
                    ? this._listeners instanceof c
                      ? (((z = this._deliveryQueue) !== null && z !== void 0) || (this._deliveryQueue = new E()),
                        (this._listeners = [this._listeners, k]))
                      : this._listeners.push(k)
                    : ((T = (x = this._options) === null || x === void 0 ? void 0 : x.onWillAddFirstListener) === null ||
                        T === void 0 ||
                        T.call(x, this),
                      (this._listeners = k),
                      (U = (F = this._options) === null || F === void 0 ? void 0 : F.onDidAddFirstListener) === null ||
                        U === void 0 ||
                        U.call(F, this)),
                  this._size++;
                ...
                return D instanceof i.DisposableStore ? D.add(V) : Array.isArray(D) && D.push(V), V;
              }),
            this._event
          );
        }
        _removeListener(v) {
          var R, N, D, x;
          if (
            ((N = (R = this._options) === null || R === void 0 ? void 0 : R.onWillRemoveListener) === null || N === void 0 || N.call(R, this),
            !this._listeners)
          )
            return;
          if (this._size === 1) {
            (this._listeners = void 0),
              (x = (D = this._options) === null || D === void 0 ? void 0 : D.onDidRemoveLastListener) === null || x === void 0 || x.call(D, this),
              (this._size = 0);
            return;
          }
          ...
          if (this._size * m <= T.length) {
            ...
            for (let k = 0; k < T.length; k++)
              T[k] ? (T[z++] = T[k]) : U && (this._deliveryQueue.end--, z < this._deliveryQueue.i && this._deliveryQueue.i--);
            T.length = z;
          }
        }
        _deliver(v, R) {
        ...
        fire(v) {
          this.hasListeners() &&
            ...
            this._queuedEvents.length === 1 &&
              queueMicrotask(() => {
                this._mergeFn ? super.fire(this._mergeFn(this._queuedEvents)) : this._queuedEvents.forEach((R) => super.fire(R)),
                  (this._queuedEvents = []);
              }));
        }
      }
      ...
      class p {
        ...
        set input(v) {
          (this.inputEvent = v),
            this.listening && (this.inputEventListener.dispose(), (this.inputEventListener = v(this.emitter.fire, this.emitter)));
        }
        dispose() {
    ...
    X(J[38], Z([0, 1, 9]), function (q, n, M) {
      ...
      (function (L) {
        ...
        (L.isCancellationToken = h),
          (L.None = Object.freeze({isCancellationRequested: !1, onCancellationRequested: M.Event.None})),
          (L.Cancelled = Object.freeze({isCancellationRequested: !0, onCancellationRequested: A}));
      ...
      class g {
        constructor(h) {
          (this._token = void 0), (this._parentListener = void 0), (this._parentListener = h && h.onCancellationRequested(this.cancel, this));
        }
        get token() {
    ...
    X(J[6], Z([0, 1, 32, 36]), function (q, n, M, A) {
      ...
      function m(P, B, W = {}) {
        ...
        B || (P = o(P)), W.wholeWord && (/\B/.test(P.charAt(0)) || (P = '\\b' + P), /\B/.test(P.charAt(P.length - 1)) || (P = P + '\\b'));
        let $ = '';
        return W.global && ($ += 'g'), W.matchCase || ($ += 'i'), W.multiline && ($ += 'm'), W.unicode && ($ += 'u'), new RegExp(P, $);
      }
      n.createRegExp = m;
      function f(P) {
        return P.source === '^' || P.source === '^$' || P.source === '$' || P.source === '^\\s*$' ? !1 : !!(P.exec('') && P.lastIndex === 0);
      }
      ...
      (n.AmbiguousCharacters = ee),
        ...
        (ee._locales = new A.Lazy(() => Object.keys(i.ambiguousCharacterData.value).filter((P) => !P.startsWith('_'))));
      class ne {
        static getRawData() {
          return JSON.parse(
    ...
    X(J[39], Z([0, 1, 6]), function (q, n, M) {
      'use strict';
      Object.defineProperty(n, '__esModule', {value: !0}), (n.StringSHA1 = n.toHexString = n.stringHash = n.numberHash = n.doHash = n.hash = void 0);
      function A(m) {
        return i(m, 0);
      }
      n.hash = A;
      ...
      class c {
        ...
        _push(f, S, w) {
          return (
            w < 128
              ...
              : w < 65536
              ? ((f[S++] = 224 | ((w & 61440) >>> 12)), (f[S++] = 128 | ((w & 4032) >>> 6)), (f[S++] = 128 | ((w & 63) >>> 0)))
              : ((f[S++] = 240 | ((w & 1835008) >>> 18)),
                (f[S++] = 128 | ((w & 258048) >>> 12)),
                (f[S++] = 128 | ((w & 4032) >>> 6)),
                (f[S++] = 128 | ((w & 63) >>> 0))),
            S >= 64 && (this._step(), (S -= 64), (this._totalLen += 64), (f[0] = f[64 + 0]), (f[1] = f[64 + 1]), (f[2] = f[64 + 2])),
            S
          );
        }
        digest() {
          return (
            this._finished ||
              ((this._finished = !0),
              this._leftoverHighSurrogate && ((this._leftoverHighSurrogate = 0), (this._buffLen = this._push(this._buff, this._buffLen, 65533))),
        ...
        _step() {
          ...
          for (let b = 64; b < 320; b += 4)
            f.setUint32(b, C(f.getUint32(b - 12, !1) ^ f.getUint32(b - 32, !1) ^ f.getUint32(b - 56, !1) ^ f.getUint32(b - 64, !1), 1), !1);
          let w = this._h0,
            E = this._h1,
            y = this._h2,
            _ = this._h3,
      ...
      class h {
        ...
        MarkNextChange() {
          (this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
            this.m_changes.push(new M.DiffChange(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount)),
            (this.m_originalCount = 0),
            (this.m_modifiedCount = 0),
            (this.m_originalStart = 1073741824),
            (this.m_modifiedStart = 1073741824);
      ...
      class o {
        ...
        ComputeDiffRecursive(e, a, u, c, m) {
          ...
          if (e > a || u > c) {
            ...
            return (
              u <= c
                ? (g.Assert(e === a + 1, 'originalStart should only be one more than originalEnd'), (_ = [new M.DiffChange(e, 0, u, c - u + 1)]))
                : e <= a
                ? (g.Assert(u === c + 1, 'modifiedStart should only be one more than modifiedEnd'), (_ = [new M.DiffChange(e, a - e + 1, u, 0)]))
        ...
        WALKTRACE(e, a, u, c, m, f, S, w, E, y, _, r, s, l, p, b, v, R) {
          ...
          do {
            const O = U + e;
            O === T || (O < F && E[O - 1] < E[O + 1])
              ? ((_ = E[O + 1]), (l = _ - U - c), _ < z && x.MarkNextChange(), (z = _), x.AddModifiedElement(_ + 1, l), (U = O + 1 - e))
              : ((_ = E[O - 1] + 1), (l = _ - U - c), _ < z && x.MarkNextChange(), (z = _ - 1), x.AddOriginalElement(_, l + 1), (U = O - 1 - e)),
          ...
          if (((N = x.getReverseChanges()), R[0])) {
            ...
            do {
              const O = U + m;
              O === T || (O < F && y[O - 1] >= y[O + 1])
                ? ((_ = y[O + 1] - 1), (l = _ - U - w), _ > z && x.MarkNextChange(), (z = _ + 1), x.AddOriginalElement(_ + 1, l + 1), (U = O + 1 - m))
                : ((_ = y[O - 1]), (l = _ - U - w), _ > z && x.MarkNextChange(), (z = _), x.AddModifiedElement(_ + 1, l + 1), (U = O - 1 - m)),
                k >= 0 && ((y = this.m_reverseHistory[k]), (m = y[0]), (T = 1), (F = y.length - 1));
            } while (--k >= -1);
            D = x.getChanges();
          }
        ...
        ComputeRecursionPoint(e, a, u, c, m, f, S) {
          ...
          for (let U = 1; U <= l / 2 + 1; U++) {
            let z = 0,
              k = 0;
            (y = this.ClipDiagonalBound(R - U, U, R, p)), (_ = this.ClipDiagonalBound(R + U, U, R, p));
            for (let I = y; I <= _; I += 2) {
              I === y || (I < _ && b[I - 1] < b[I + 1]) ? (w = b[I + 1]) : (w = b[I - 1] + 1), (E = w - (I - R) - D);
              const V = w;
              for (; w < a && E < c && this.ElementsAreEqual(w + 1, E + 1); ) w++, E++;
              if (((b[I] = w), w + E > z + k && ((z = w), (k = E)), !F && Math.abs(I - N) <= U - 1 && w >= v[I]))
                return (
                  (m[0] = w),
                  (f[0] = E),
                  V <= v[I] && 1447 > 0 && U <= 1447 + 1 ? this.WALKTRACE(R, y, _, D, N, r, s, x, b, v, w, a, m, E, c, f, F, S) : null
                );
            }
            const O = (z - e + (k - u) - U) / 2;
            if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(z, O))
              return (
                (S[0] = !0),
                (m[0] = z),
                (f[0] = k),
            ...
            (r = this.ClipDiagonalBound(N - U, U, N, p)), (s = this.ClipDiagonalBound(N + U, U, N, p));
            for (let I = r; I <= s; I += 2) {
              ...
              if (((v[I] = w), F && Math.abs(I - R) <= U && w <= b[I]))
                return (
                  (m[0] = w),
                  (f[0] = E),
                  V >= b[I] && 1447 > 0 && U <= 1447 + 1 ? this.WALKTRACE(R, y, _, D, N, r, s, x, b, v, w, a, m, E, c, f, F, S) : null
                );
            }
            if (U <= 1447) {
        ...
        PrettifyChanges(e) {
          for (let a = 0; a < e.length; a++) {
            ...
            for (
              ...
              (!S || this.ModifiedElementsAreEqual(u.modifiedStart, u.modifiedStart + u.modifiedLength));

            ) {
              const E = this.ElementsAreStrictEqual(u.originalStart, u.modifiedStart);
              if (this.ElementsAreStrictEqual(u.originalStart + u.originalLength, u.modifiedStart + u.modifiedLength) && !E) break;
          ...
          for (let a = e.length - 1; a >= 0; a--) {
            ...
            for (let _ = 1; ; _++) {
              ...
              if (
                ...
                break;
              const p = (r === c && s === m ? 5 : 0) + this._boundaryScore(r, u.originalLength, s, u.modifiedLength);
              p > E && ((E = p), (w = _));
            }
          ...
          if (this._hasStrings)
            for (let a = 1, u = e.length; a < u; a++) {
              ...
              if (f < 5 && E < 20 && r < 20) {
                ...
                if (s) {
                  const [l, p] = s;
                  (l !== c.originalStart + c.originalLength || p !== c.modifiedStart + c.modifiedLength) &&
        ...
        ConcatenateChanges(e, a) {
          ...
          if (this.ChangesOverlap(e[e.length - 1], a[0], u)) {
            ...
            return L.Copy(e, 0, c, 0, e.length - 1), (c[e.length - 1] = u[0]), L.Copy(a, 1, c, e.length, a.length - 1), c;
          } else {
        ...
        ChangesOverlap(e, a, u) {
          if (
            (g.Assert(e.originalStart <= a.originalStart, 'Left change is not less than or equal to right change'),
            g.Assert(e.modifiedStart <= a.modifiedStart, 'Left change is not less than or equal to right change'),
            e.originalStart + e.originalLength >= a.originalStart || e.modifiedStart + e.modifiedLength >= a.modifiedStart)
          ) {
            ...
            return (
              e.originalStart + e.originalLength >= a.originalStart && (m = a.originalStart + a.originalLength - e.originalStart),
              e.modifiedStart + e.modifiedLength >= a.modifiedStart && (S = a.modifiedStart + a.modifiedLength - e.modifiedStart),
    ...
    X(J[25], Z([0, 1]), function (q, n) {
      ...
      function m(f, S) {
        if (M(S)) {
          ...
          if ((!C(f) && f.constructor === S) || (S.length === 1 && S.call(void 0, f) === !0)) return;
          throw new Error(
    ...
    X(J[14], Z([0, 1, 25]), function (q, n, M) {
        ...
        return (0, M.isObject)(u)
          ? ((0, M.isObject)(c) &&
              Object.keys(c).forEach((f) => {
                f in u ? m && ((0, M.isObject)(u[f]) && (0, M.isObject)(c[f]) ? h(u[f], c[f], m) : (u[f] = c[f])) : (u[f] = c[f]);
              }),
            u)
          : c;
      }
      ...
      function o(u, c) {
        if (u === c) return !0;
        if (u == null || c === null || c === void 0 || typeof u != typeof c || typeof u != 'object' || Array.isArray(u) !== Array.isArray(c))
          return !1;
        let m, f;
        if (Array.isArray(u)) {
    ...
    X(J[27], Z([0, 1, 26]), function (q, n, M) {
      ...
      class A {
        constructor(g) {
          ...
          (this._defaultValue = L), (this._asciiMap = A._createAsciiMap(L)), (this._map = new Map());
        }
    ...
    X(J[3], Z([0, 1, 5]), function (q, n, M) {
      ...
      class A {
        ...
        constructor(g, L) {
          if (((this.start = g), (this.endExclusive = L), g > L)) throw new M.BugIndicatingError(`Invalid range: ${this.toString()}`);
        }
        get isEmpty() {
      ...
      class i {
        ...
        addRange(g) {
          let L = 0;
          for (; L < this._sortedRanges.length && this._sortedRanges[L].endExclusive < g.start; ) L++;
          let h = L;
          for (; h < this._sortedRanges.length && this._sortedRanges[h].start <= g.endExclusive; ) h++;
    ...
    X(J[2], Z([0, 1, 4]), function (q, n, M) {
      ...
      class A {
        constructor(d, g, L, h) {
          d > L || (d === L && g > h)
            ? ((this.startLineNumber = L), (this.startColumn = h), (this.endLineNumber = d), (this.endColumn = g))
            : ((this.startLineNumber = d), (this.startColumn = g), (this.endLineNumber = L), (this.endColumn = h));
        }
        isEmpty() {
    ...
    X(J[10], Z([0, 1, 5, 3, 2, 11]), function (q, n, M, A, i, d) {
      ...
      class g {
        ...
        constructor(o, C) {
          if (o > C) throw new M.BugIndicatingError(`startLineNumber ${o} cannot be after endLineNumberExclusive ${C}`);
        ...
        join(o) {
          return new g(Math.min(this.startLineNumber, o.startLineNumber), Math.max(this.endLineNumberExclusive, o.endLineNumberExclusive));
        }
        toString() {
          return `[${this.startLineNumber},${this.endLineNumberExclusive})`;
        }
      ...
      class L {
        ...
        addRange(o) {
          if (o.length === 0) return;
          const C = (0, d.findFirstIdxMonotonousOrArrLen)(this._normalizedRanges, (a) => a.endLineNumberExclusive >= o.startLineNumber),
            e = (0, d.findLastIdxMonotonous)(this._normalizedRanges, (a) => a.startLineNumber <= o.endLineNumberExclusive) + 1;
        ...
        contains(o) {
          const C = (0, d.findLastMonotonous)(this._normalizedRanges, (e) => e.startLineNumber <= o);
          return !!C && C.endLineNumberExclusive > o;
        }
        intersects(o) {
          const C = (0, d.findLastMonotonous)(this._normalizedRanges, (e) => e.startLineNumber < o.endLineNumberExclusive);
        ...
        getUnion(o) {
          ...
          for (; e < this._normalizedRanges.length || a < o._normalizedRanges.length; ) {
            ...
            } else e < this._normalizedRanges.length ? ((c = this._normalizedRanges[e]), e++) : ((c = o._normalizedRanges[a]), a++);
            u === null
              ? (u = c)
              : u.endLineNumberExclusive >= c.startLineNumber
              ? (u = new g(u.startLineNumber, Math.max(u.endLineNumberExclusive, c.endLineNumberExclusive)))
              : (C.push(u), (u = c));
          }
          return u !== null && C.push(u), new L(C);
        }
        subtractFrom(o) {
          const C = (0, d.findFirstIdxMonotonousOrArrLen)(this._normalizedRanges, (c) => c.endLineNumberExclusive >= o.startLineNumber),
            e = (0, d.findLastIdxMonotonous)(this._normalizedRanges, (c) => c.startLineNumber <= o.endLineNumberExclusive) + 1;
          if (C === e) return new L([o]);
          const a = [];
          let u = o.startLineNumber;
          for (let c = C; c < e; c++) {
            const m = this._normalizedRanges[c];
            m.startLineNumber > u && a.push(new g(u, m.startLineNumber)), (u = m.endLineNumberExclusive);
          }
          return u < o.endLineNumberExclusive && a.push(new g(u, o.endLineNumberExclusive)), new L(a);
        }
        toString() {
        ...
        getIntersection(o) {
          ...
          for (; e < this._normalizedRanges.length && a < o._normalizedRanges.length; ) {
            const u = this._normalizedRanges[e],
              ...
              m = u.intersect(c);
            m && !m.isEmpty && C.push(m), u.endLineNumberExclusive < c.endLineNumberExclusive ? e++ : a++;
          }
          return new L(C);
        }
        getWithDelta(o) {
    ...
    X(J[41], Z([0, 1, 4, 2]), function (q, n, M, A) {
      ...
      class i extends A.Range {
        ...
        setStartPosition(g, L) {
          return this.getDirection() === 0 ? new i(g, L, this.endLineNumber, this.endColumn) : new i(this.endLineNumber, this.endColumn, g, L);
        }
        ...
        static liftSelection(g) {
          return new i(g.selectionStartLineNumber, g.selectionStartColumn, g.positionLineNumber, g.positionColumn);
        }
        static selectionsArrEqual(g, L) {
          if ((g && !L) || (!g && L)) return !1;
          if (!g && !L) return !0;
          if (g.length !== L.length) return !1;
          for (let h = 0, o = g.length; h < o; h++) if (!this.selectionsEqual(g[h], L[h])) return !1;
          return !0;
        }
    ...
    X(J[42], Z([0, 1, 27]), function (q, n, M) {
      'use strict';
      Object.defineProperty(n, '__esModule', {value: !0}), (n.getMapForWordSeparators = n.WordCharacterClassifier = void 0);
    ...
    X(J[28], Z([0, 1, 21, 22]), function (q, n, M, A) {
      ...
      function d(o) {
        ...
        if (o && o instanceof RegExp)
          if (o.global) C = o;
            ...
            let e = 'g';
            o.ignoreCase && (e += 'i'), o.multiline && (e += 'm'), o.unicode && (e += 'u'), (C = new RegExp(o.source, e));
          }
      ...
      function L(o, C, e, a, u) {
        if (((C = d(C)), u || (u = M.Iterable.first(g)), e.length > u.maxLen)) {
          let w = o - u.maxLen / 2;
          return w < 0 ? (w = 0) : (a += w), (e = e.substring(w, o + u.maxLen / 2)), L(o, C, e, a, u);
        }
        const c = Date.now(),
          m = o - 1 - a;
        let f = -1,
        ...
        if (S) {
          const w = {word: S[0], startColumn: a + 1 + S.index, endColumn: a + 1 + S.index + S[0].length};
    ...
    X(J[8], Z([0, 1, 7, 5, 3]), function (q, n, M, A, i) {
      ...
      class d {
        static trivial(e, a) {
          return new d([new g(i.OffsetRange.ofLength(e.length), i.OffsetRange.ofLength(a.length))], !1);
        }
        static trivialTimedOut(e, a) {
          return new d([new g(i.OffsetRange.ofLength(e.length), i.OffsetRange.ofLength(a.length))], !0);
        }
        constructor(e, a) {
      ...
      class g {
            ...
            (0, M.forEachAdjacent)(e, (c, m) => {
              u.push(
                g.fromOffsetPairs(
                  ...
                  m ? m.getStarts() : new L(a, (c ? c.seq2Range.endExclusive - c.seq1Range.endExclusive : 0) + a)
                )
              );
            }),
            u
        ...
        static fromOffsetPairs(e, a) {
          return new g(new i.OffsetRange(e.offset1, a.offset1), new i.OffsetRange(e.offset2, a.offset2));
        }
        constructor(e, a) {
      ...
      (n.OffsetPair = L), (L.zero = new L(0, 0)), (L.max = new L(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER));
      class h {
        isValid() {
          return !0;
        }
        ...
        compute(o, C, e = A.InfiniteTimeout.instance) {
          ...
          e: for (;;) {
            ...
            for (w = s; w <= l; w += 2) {
              ...
              if ((S.set(w, D !== R ? new d(x, R, N, D - R) : x), f.get(w) === a.length && f.get(w) - w === u.length)) break e;
            }
          }
          let E = S.get(w);
          const y = [];
          ...
          for (;;) {
            const s = E ? E.x + E.length : 0,
              l = E ? E.y + E.length : 0;
            if (((s !== _ || l !== r) && y.push(new A.SequenceDiff(new M.OffsetRange(s, _), new M.OffsetRange(l, r))), !E)) break;
    ...
    X(J[43], Z([0, 1, 7, 3, 8]), function (q, n, M, A, i) {
        ...
        for (let E = 1; E < f.length; E++) {
          ...
          if (_.seq1Range.isEmpty || _.seq2Range.isEmpty) {
            ...
            for (
              ...
              s <= r &&
              !(
                c.getElement(_.seq1Range.start - s) !== c.getElement(_.seq1Range.endExclusive - s) ||
      ...
      function L(c, m, f) {
        ...
        for (let S = 0; S < f.length; S++) {
          const w = S > 0 ? f[S - 1] : void 0,
            ...
            _ = new A.OffsetRange(w ? w.seq1Range.start + 1 : 0, y ? y.seq1Range.endExclusive - 1 : c.length),
            r = new A.OffsetRange(w ? w.seq2Range.start + 1 : 0, y ? y.seq2Range.endExclusive - 1 : m.length);
          E.seq1Range.isEmpty ? (f[S] = h(E, c, m, _, r)) : E.seq2Range.isEmpty && (f[S] = h(E.swap(), m, c, r, _).swap());
        }
        return f;
      }
      ...
      function o(c, m, f) {
        ...
        for (const w of f) {
          ...
          w.seq1Range.start - E.seq1Range.endExclusive <= 2 || w.seq2Range.start - E.seq2Range.endExclusive <= 2
            ? (S[S.length - 1] = new i.SequenceDiff(E.seq1Range.join(w.seq1Range), E.seq2Range.join(w.seq2Range)))
            : S.push(w);
        }
        return S;
      }
      ...
      function C(c, m, f) {
        ...
        function E() {
          ...
          Math.max(w.deleted, w.added) + (w.count - 1) > _ && S.push(new i.SequenceDiff(w.s1Range, w.s2Range)), (w = void 0);
        }
        for (const _ of f) {
          let r = function (v, R) {
            var N, D, x, T;
            ...
            w.count++, (w.deleted += (x = F?.length) !== null && x !== void 0 ? x : 0), (w.added += (T = U?.length) !== null && T !== void 0 ? T : 0);
          };
          ...
          s && p && l && b && s.equals(p) && l.equals(b) ? r(s, l) : (s && l && r(s, l), p && b && r(p, b));
        }
        return E(), e(f, S);
      }
      ...
      function e(c, m) {
        ...
        for (; c.length > 0 || m.length > 0; ) {
          ...
          S && (!w || S.seq1Range.start < w.seq1Range.start) ? (E = c.shift()) : (E = m.shift()),
            f.length > 0 && f[f.length - 1].seq1Range.endExclusive >= E.seq1Range.start ? (f[f.length - 1] = f[f.length - 1].join(E)) : f.push(E);
        }
        return f;
      }
      function a(c, m, f) {
          ...
          for (let _ = 1; _ < S.length; _++) {
            let l = function (b, v) {
              ...
              return (
                ...
                (b.seq1Range.length + b.seq2Range.length > 5 || v.seq1Range.length + v.seq2Range.length > 5)
              );
            };
            const r = S[_],
              s = y[y.length - 1];
      ...
      function u(c, m, f) {
        ...
        return (
          (0, M.forEachWithNeighbors)(S, (_, r, s) => {
            ...
            const N = i.SequenceDiff.fromOffsetPairs(_ ? _.getEndExclusives() : i.OffsetPair.zero, s ? s.getStarts() : i.OffsetPair.max),
              D = l.intersect(N);
            y.push(D);
          }),
          y
...
`);
        ...
        computeSimilarity(g) {
          ...
          for (let e = 0; e < C; e++)
            o += Math.abs(((L = this.histogram[e]) !== null && L !== void 0 ? L : 0) - ((h = g.histogram[e]) !== null && h !== void 0 ? h : 0));
        ...
        compute(L, h, o = A.InfiniteTimeout.instance, C) {
          ...
          for (let y = 0; y < L.length; y++)
            for (let _ = 0; _ < h.length; _++) {
              ...
              } else p === r ? (u.set(y, _, 0), a.set(y, _, 1)) : p === s && (u.set(y, _, 0), a.set(y, _, 2));
              e.set(y, _, p);
            }
          const c = [];
          let m = L.length,
            f = h.length;
          function S(y, _) {
            (y + 1 !== m || _ + 1 !== f) && c.push(new A.SequenceDiff(new M.OffsetRange(y + 1, m), new M.OffsetRange(_ + 1, f))), (m = y), (f = _);
          }
          let w = L.length - 1,
            E = h.length - 1;
          for (; w >= 0 && E >= 0; ) a.get(w, E) === 3 ? (S(w, E), w--, E--) : a.get(w, E) === 1 ? w-- : E--;
...
`.charCodeAt(0)
        ...
        getBoundaryScore(u) {
          ...
          if (c === 7 && m === 8) return 0;
          let f = 0;
          return c !== m && ((f += 10), c === 0 && m === 1 && (f += 1)), (f += C(c)), (f += C(m)), f;
        }
        translateOffset(u) {
          ...
          return new i.Position(this.lineRange.start + c + 1, u - this.firstCharOffsetByLine[c] + this.additionalOffsetByLine[c] + 1);
        }
        translateRange(u) {
        ...
        extendToFullLines(u) {
          var c, m;
          const f = (c = (0, M.findLastMonotonous)(this.firstCharOffsetByLine, (w) => w <= u.start)) !== null && c !== void 0 ? c : 0,
            S =
              (m = (0, M.findFirstMonotonous)(this.firstCharOffsetByLine, (w) => u.endExclusive <= w)) !== null && m !== void 0
                ? m
    ...
    X(J[16], Z([0, 1, 10]), function (q, n, M) {
      ...
      class A {
        static inverse(L, h, o) {
          ...
          let e = 1,
            a = 1;
          for (const c of L) {
            const m = new i(new M.LineRange(e, c.original.startLineNumber), new M.LineRange(a, c.modified.startLineNumber), void 0);
            m.modified.isEmpty || C.push(m), (e = c.original.endLineNumberExclusive), (a = c.modified.endLineNumberExclusive);
          }
      ...
      class i extends A {
        ...
        flip() {
          var L;
          return new i(this.modified, this.original, (L = this.innerChanges) === null || L === void 0 ? void 0 : L.map((h) => h.flip()));
        }
      }
    ...
    X(J[46], Z([0, 1, 8, 16, 7, 11, 37, 10, 3, 30, 15, 29]), function (q, n, M, A, i, d, g, L, h, o, C, e) {
      'use strict';
...
`).length >= 15 && u(D, (T) => T.length >= 2) >= 2
      ...
      function c(E, y, _, r) {
        const s = [],
          l = E.filter((v) => v.modified.isEmpty && v.original.length >= 3).map((v) => new C.LineRangeFragment(v.original, y, v)),
          p = new Set(E.filter((v) => v.original.isEmpty && v.modified.length >= 3).map((v) => new C.LineRangeFragment(v.modified, _, v))),
          b = new Set();
        for (const v of l) {
          let R = -1,
            N;
          ...
          if ((R > 0.9 && N && (p.delete(N), s.push(new A.LineRangeMapping(v.range, N.range)), b.add(v.source), b.add(N.source)), !r.isValid()))
      ...
      function m(E, y, _, r, s, l) {
            ...
            b.forEach(U, ({range: O}) => {
              for (const V of T)
                if (
                  ...
                  (V.originalLineRange = new L.LineRange(V.originalLineRange.startLineNumber, O.endLineNumberExclusive)),
                    (V.modifiedLineRange = new L.LineRange(V.modifiedLineRange.startLineNumber, z.endLineNumberExclusive)),
                    k.push(V);
                  return;
                }
        ...
        for (let x = 0; x < p.length; x++) {
          const T = p[x],
            F = D.findLastMonotonous((Y) => Y.original.startLineNumber <= T.original.startLineNumber),
            U = (0, d.findLastMonotonous)(E, (Y) => Y.modified.startLineNumber <= T.modified.startLineNumber),
            z = Math.max(T.original.startLineNumber - F.original.startLineNumber, T.modified.startLineNumber - U.modified.startLineNumber),
            k = D.findLastMonotonous((Y) => Y.original.startLineNumber < T.original.endLineNumberExclusive),
            O = (0, d.findLastMonotonous)(E, (Y) => Y.modified.startLineNumber < T.modified.endLineNumberExclusive),
            I = Math.max(
          ...
          for (V = 0; V < z; V++) {
            ...
            if (Y > r.length || t > s.length || R.contains(t) || N.contains(Y) || !f(r[Y - 1], s[t - 1], l)) break;
          }
          V > 0 &&
            (N.addRange(new L.LineRange(T.original.startLineNumber - V, T.original.startLineNumber)),
            R.addRange(new L.LineRange(T.modified.startLineNumber - V, T.modified.startLineNumber)));
          let H;
          for (H = 0; H < I; H++) {
          ...
          H > 0 &&
            (N.addRange(new L.LineRange(T.original.endLineNumberExclusive, T.original.endLineNumberExclusive + H)),
            R.addRange(new L.LineRange(T.modified.endLineNumberExclusive, T.modified.endLineNumberExclusive + H))),
            (V > 0 || H > 0) &&
              (p[x] = new A.LineRangeMapping(
                new L.LineRange(T.original.startLineNumber - V, T.original.endLineNumberExclusive + H),
                new L.LineRange(T.modified.startLineNumber - V, T.modified.endLineNumberExclusive + H)
              ));
        }
        return p;
      }
      ...
      function w(E, y) {
        ...
        return (
          (y = y.filter((r) => {
            const s =
                _.findLastMonotonous((b) => b.original.startLineNumber < r.original.endLineNumberExclusive) ||
                new A.LineRangeMapping(new L.LineRange(1, 1), new L.LineRange(1, 1)),
              l = (0, d.findLastMonotonous)(E, (b) => b.modified.startLineNumber < r.modified.endLineNumberExclusive);
            return s !== l;
          })),
          y
        );
    ...
    X(J[47], Z([0, 1, 7, 12, 10, 3, 2, 8, 45, 29, 46, 43, 31, 16, 30, 44]), function (q, n, M, A, i, d, g, L, h, o, C, e, a, u, c, m) {
      'use strict';
      Object.defineProperty(n, '__esModule', {value: !0}),
        (n.getLineRangeMapping = n.lineRangeMappingFromRangeMappings = n.DefaultLinesDiffComputer = void 0);
      class f {
        constructor() {
          (this.dynamicProgrammingDiffing = new h.DynamicProgrammingDiffing()), (this.myersDiffingAlgorithm = new o.MyersDiffAlgorithm());
        }
        computeDiff(y, _, r) {
          if (y.length <= 1 && (0, M.equals)(y, _, (H, Y) => H === Y)) return new a.LinesDiff([], [], !1);
          if ((y.length === 1 && y[0].length === 0) || (_.length === 1 && _[0].length === 0))
            return new a.LinesDiff(
              [
                new u.DetailedLineRangeMapping(new i.LineRange(1, y.length + 1), new i.LineRange(1, _.length + 1), [
                  new u.RangeMapping(new g.Range(1, 1, y.length, y[0].length + 1), new g.Range(1, 1, _.length, _[0].length + 1)),
                ]),
              ],
              [],
              !1
            );
          const s = r.maxComputationTimeMs === 0 ? L.InfiniteTimeout.instance : new L.DateTimeout(r.maxComputationTimeMs),
            ...
            x = (() =>
              N.length + D.length < 1700
                ? this.dynamicProgrammingDiffing.compute(N, D, s, (H, Y) =>
                    y[H] === _[Y] ? (_[Y].length === 0 ? 0.1 : 1 + Math.log(1 + _[Y].length)) : 0.99
                  )
              ...
              if (l)
                for (let Y = 0; Y < H; Y++) {
                  const t = k + Y,
                    re = O + Y;
                  if (y[t] !== _[re]) {
                    const le = this.refineDiff(y, _, new L.SequenceDiff(new d.OffsetRange(t, t + 1), new d.OffsetRange(re, re + 1)), s, l);
        ...
        computeMoves(y, _, r, s, l, p, b) {
          return (0, C.computeMovedLines)(y, _, r, s, l, p).map((N) => {
            const D = this.refineDiff(_, r, new L.SequenceDiff(N.original.toOffsetRange(), N.modified.toOffsetRange()), p, b),
        ...
        refineDiff(y, _, r, s, l) {
          const p = new c.LinesSliceCharSequence(y, r.seq1Range, l),
            ...
            v = p.length + b.length < 500 ? this.dynamicProgrammingDiffing.compute(p, b, s) : this.myersDiffingAlgorithm.compute(p, b, s);
          let R = v.diffs;
          return (
            ...
            {mappings: R.map((D) => new u.RangeMapping(p.translateRange(D.seq1Range), b.translateRange(D.seq2Range))), hitTimeout: v.hitTimeout}
          );
        }
      }
      ...
      function S(E, y, _, r = !1) {
        ...
        for (const l of (0, M.groupAdjacentBy)(
          E.map((p) => w(p, y, _)),
          (p, b) => p.original.overlapOrTouch(b.original) || p.modified.overlapOrTouch(b.modified)
        )) {
          const p = l[0],
            b = l[l.length - 1];
          s.push(
      ...
      function w(E, y, _) {
        ...
        const l = new i.LineRange(E.originalRange.startLineNumber + r, E.originalRange.endLineNumber + 1 + s),
          p = new i.LineRange(E.modifiedRange.startLineNumber + r, E.modifiedRange.endLineNumber + 1 + s);
    ...
    X(J[48], Z([0, 1, 24, 31, 16, 6, 2, 12, 10]), function (q, n, M, A, i, d, g, L, h) {
            ...
            let F = new i.DetailedLineRangeMapping(
              ...
              (p = D.charChanges) === null || p === void 0
                ...
                : p.map(
                    (U) =>
                      new i.RangeMapping(
                        new g.Range(U.originalStartLineNumber, U.originalStartColumn, U.originalEndLineNumber, U.originalEndColumn),
                        new g.Range(U.modifiedStartLineNumber, U.modifiedStartColumn, U.modifiedEndLineNumber, U.modifiedEndColumn)
                      )
                  )
            );
            N &&
          ...
          return (
            (0, L.assertFn)(() =>
              (0, L.checkAdjacentItems)(
                R,
                (D, x) =>
                  x.original.startLineNumber - D.original.endLineNumberExclusive === x.modified.startLineNumber - D.modified.endLineNumberExclusive &&
      ...
      class a {
        ...
        getElements() {
          const r = [];
          for (let s = 0, l = this.lines.length; s < l; s++) r[s] = this.lines[s].substring(this._startColumns[s] - 1, this._endColumns[s] - 1);
          return r;
        }
        getStrictElement(r) {
          return this.lines[r];
        ...
        createCharSequence(r, s, l) {
          ...
          for (let N = s; N <= l; N++) {
            ...
            for (let F = x; F < T; F++) (p[R] = D.charCodeAt(F - 1)), (b[R] = N + 1), (v[R] = F), R++;
      ...
      class u {
        ...
        getEndLineNumber(r) {
          return r === -1
            ...
            : (this._assertIndex(r, this._lineNumbers), this._charCodes[r] === 10 ? this._lineNumbers[r] + 1 : this._lineNumbers[r]);
        }
        getStartColumn(r) {
        ...
        static createFromDiffResult(r, s, l, p, b, v, R) {
          ...
          if (
            (s.originalLength === 0
              ...
              : ((N = l.getStartLineNumber(s.originalStart)), (D = l.getEndLineNumber(s.originalStart + s.originalLength - 1))),
            s.modifiedLength === 0
              ? ((x = p.getStartLineNumber(s.modifiedStart) - 1), (T = 0))
              : ((x = p.getStartLineNumber(s.modifiedStart)), (T = p.getEndLineNumber(s.modifiedStart + s.modifiedLength - 1))),
            v && s.originalLength > 0 && s.originalLength < 20 && s.modifiedLength > 0 && s.modifiedLength < 20 && b())
          ) {
            const U = l.createCharSequence(r, s.originalStart, s.originalStart + s.originalLength - 1),
      ...
      class S {
        constructor(r, s, l) {
          (this.shouldComputeCharChanges = l.shouldComputeCharChanges),
            ...
            (this.continueCharDiff = y(l.maxComputationTime === 0 ? 0 : Math.min(l.maxComputationTime, 5e3)));
        }
        computeDiff() {
              ...
              if (F !== U) {
                {
                  ...
                  (z > 1 || k > 1) && this._pushTrimWhitespaceCharChange(p, b + 1, 1, z, v + 1, 1, k);
                }
                {
                  let z = E(F, 1),
                    k = E(U, 1);
                  ...
                  (z < O || k < I) && this._pushTrimWhitespaceCharChange(p, b + 1, z, O, v + 1, k, I);
                }
              }
              b++, v++;
            }
        ...
        _pushTrimWhitespaceCharChange(r, s, l, p, b, v, R) {
          ...
          let N;
          this.shouldComputeCharChanges && (N = [new c(s, l, s, p, b, v, b, R)]), r.push(new f(s, s, b, b, N));
        }
        _mergeTrimWhitespaceCharChange(r, s, l, p, b, v, R) {
          ...
          return D.originalEndLineNumber === 0 || D.modifiedEndLineNumber === 0
            ...
            ? (this.shouldComputeCharChanges && D.charChanges && D.charChanges.push(new c(s, l, s, p, b, v, b, R)), !0)
            : D.originalEndLineNumber + 1 === s && D.modifiedEndLineNumber + 1 === b
            ? ((D.originalEndLineNumber = s),
              (D.modifiedEndLineNumber = b),
              this.shouldComputeCharChanges && D.charChanges && D.charChanges.push(new c(s, l, s, p, b, v, b, R)),
              !0)
            : !1;
        }
      }
    ...
    X(J[49], Z([0, 1, 48, 47]), function (q, n, M, A) {
      ...
      Object.defineProperty(n, '__esModule', {value: !0}),
        ...
        (n.linesDiffComputers = {getLegacy: () => new M.LegacyLinesDiffComputer(), getDefault: () => new A.DefaultLinesDiffComputer()});
    }),
    X(J[50], Z([0, 1, 33]), function (q, n, M) {
      ...
      function d(a, u) {
        ...
        return {startLineNumber: f.lineNumber, startColumn: f.column, endLineNumber: f.lineNumber, endColumn: f.column + m};
      }
      function g(a, u) {
        if (!a) return;
      ...
      function e(a) {
        return !a || typeof a.getValue != 'function' || typeof a.positionAt != 'function' ? [] : C(a);
      }
    ...
    X(J[51], Z([0, 1, 27]), function (q, n, M) {
      ...
      class o {
        static _createLink(a, u, c, m, f) {
          ...
          return {range: {startLineNumber: c, startColumn: m + 1, endLineNumber: c, endColumn: S + 2}, url: u.substring(m, S + 1)};
        }
    ...
    X(J[52], Z([0, 1]), function (q, n) {
      ...
      class M {
        ...
        numberReplace(i, d) {
          ...
          return !isNaN(L) && !isNaN(h) && L === h ? (L === 0 && !d ? null : ((L = Math.floor(L * g)), (L += d ? g : -g), String(L / g))) : null;
        }
        textReplace(i, d) {
        ...
        valueSetsReplace(i, d, g) {
          let L = null;
          for (let h = 0, o = i.length; L === null && h < o; h++) L = this.valueSetReplace(i[h], d, g);
          return L;
        }
        valueSetReplace(i, d, g) {
          let L = i.indexOf(d);
          return L >= 0 ? ((L += g ? 1 : -1), L < 0 ? (L = i.length - 1) : (L %= i.length), i[L]) : null;
        }
      }
    ...
    X(J[53], Z([0, 1, 14]), function (q, n, M) {
      ...
      var A;
      (function (c) {
        (c[(c.Left = 1)] = 'Left'), (c[(c.Center = 2)] = 'Center'), (c[(c.Right = 4)] = 'Right'), (c[(c.Full = 7)] = 'Full');
      ...
      var g;
      (function (c) {
        (c[(c.Both = 0)] = 'Both'), (c[(c.Right = 1)] = 'Right'), (c[(c.Left = 2)] = 'Left'), (c[(c.None = 3)] = 'None');
    ...
    X(J[54], Z([0, 1, 7, 26]), function (q, n, M, A) {
      ...
      class i {
        ...
        setValue(h, o) {
          return (
            (h = (0, A.toUint32)(h)),
            (o = (0, A.toUint32)(o)),
            this.values[h] === o ? !1 : ((this.values[h] = o), h - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = h - 1), !0)
          );
        }
        removeValues(h, o) {
        ...
        _getPrefixSum(h) {
          ...
          o === 0 && ((this.prefixSum[0] = this.values[0]), o++), h >= this.values.length && (h = this.values.length - 1);
        ...
        getIndexOf(h) {
          ...
          let o = 0,
            ...
            u = 0;
          for (; o <= C; )
            if (((e = (o + (C - o) / 2) | 0), (a = this.prefixSum[e]), (u = a - this.values[e]), h < u)) C = e - 1;
            else if (h >= a) o = e + 1;
            else break;
          return new g(e, h - u);
        }
      ...
      class d {
        constructor(h) {
          (this._values = h), (this._isValid = !1), (this._validEndIndex = -1), (this._prefixSum = []), (this._indexBySum = []);
        }
        getTotalSum() {
      ...
      class g {
        constructor(h, o) {
          (this.index = h), (this.remainder = o), (this._prefixSumIndexOfResultBrand = void 0), (this.index = h), (this.remainder = o);
        }
      }
    ...
    X(J[55], Z([0, 1, 6, 4, 54]), function (q, n, M, A, i) {
      ...
      class d {
        constructor(L, h, o, C) {
          (this._uri = L), (this._lines = h), (this._eol = o), (this._versionId = C), (this._lineStarts = null), (this._cachedTextValue = null);
        }
        dispose() {
        ...
        onEvents(L) {
          ...
          const h = L.changes;
          for (const o of h)
            this._acceptDeleteRange(o.range), this._acceptInsertText(new A.Position(o.range.startLineNumber, o.range.startColumn), o.text);
        ...
        _setLineText(L, h) {
          (this._lines[L] = h), this._lineStarts && this._lineStarts.setValue(L, this._lines[L].length + this._eol.length);
        }
        _acceptDeleteRange(L) {
          if (L.startLineNumber === L.endLineNumber) {
            ...
            this._setLineText(
              L.startLineNumber - 1,
              this._lines[L.startLineNumber - 1].substring(0, L.startColumn - 1) + this._lines[L.startLineNumber - 1].substring(L.endColumn - 1)
            );
            return;
          }
          this._setLineText(
            L.startLineNumber - 1,
            this._lines[L.startLineNumber - 1].substring(0, L.startColumn - 1) + this._lines[L.endLineNumber - 1].substring(L.endColumn - 1)
          ),
            this._lines.splice(L.startLineNumber, L.endLineNumber - L.startLineNumber),
            this._lineStarts && this._lineStarts.removeValues(L.startLineNumber, L.endLineNumber - L.startLineNumber);
        }
        _acceptInsertText(L, h) {
          ...
          if (o.length === 1) {
            this._setLineText(
              L.lineNumber - 1,
              this._lines[L.lineNumber - 1].substring(0, L.column - 1) + o[0] + this._lines[L.lineNumber - 1].substring(L.column - 1)
            );
            return;
          }
          (o[o.length - 1] += this._lines[L.lineNumber - 1].substring(L.column - 1)),
            this._setLineText(L.lineNumber - 1, this._lines[L.lineNumber - 1].substring(0, L.column - 1) + o[0]);
          const C = new Uint32Array(o.length - 1);
          for (let e = 1; e < o.length; e++) this._lines.splice(L.lineNumber + e - 1, 0, o[e]), (C[e - 1] = o[e].length + this._eol.length);
    ...
    X(J[56], Z([0, 1, 6, 42, 4, 2, 53]), function (q, n, M, A, i, d, g) {
      'use strict';
      Object.defineProperty(n, '__esModule', {value: !0}),
        (n.Searcher = n.isValidMatch = n.TextModelSearch = n.createFindMatch = n.isMultilineRegexSource = n.SearchParams = void 0);
      const L = 999;
      class h {
        constructor(w, E, y, _) {
          (this.searchString = w), (this.isRegex = E), (this.matchCase = y), (this.wordSeparators = _);
        }
        parseSearchRequest() {
...
`) >= 0);
          let E = null;
          try {
            E = M.createRegExp(this.searchString, this.isRegex, {matchCase: this.matchCase, wholeWord: !1, multiline: w, global: !0, unicode: !0});
          } catch {
            return null;
          }
          if (!E) return null;
          ...
          return (
            y && this.searchString.toLowerCase() !== this.searchString.toUpperCase() && (y = this.matchCase),
            new g.SearchData(E, this.wordSeparators ? (0, A.getMapForWordSeparators)(this.wordSeparators) : null, y ? this.searchString : null)
          );
        }
      }
      n.SearchParams = h;
...
`
          ...
          let v = 0,
            R;
          for (y.reset(0); (R = y.next(l)); ) if (((b[v++] = C(this._getMultilineMatchRange(w, s, l, p, R.index, R[0]), R, _)), v >= r)) return b;
          return b;
        }
        static _doFindMatchesLineByLine(w, E, y, _, r) {
          ...
          if (E.startLineNumber === E.endLineNumber) {
            const b = w.getLineContent(E.startLineNumber).substring(E.startColumn - 1, E.endColumn - 1);
            return (l = this._findMatchesInLine(y, b, E.startLineNumber, E.startColumn - 1, l, s, _, r)), s;
          }
        ...
        static _findMatchesInLine(w, E, y, _, r, s, l, p) {
          ...
          if (!l && w.simpleSearch) {
            ...
            for (; (T = E.indexOf(N, T + D)) !== -1; )
              if ((!b || m(b, E, x, T, D)) && ((s[r++] = new g.FindMatch(new d.Range(y, T + 1 + _, y, T + 1 + D + _), null)), r >= p)) return r;
            return r;
          }
          const v = new f(w.wordSeparators, w.regex);
          let R;
          v.reset(0);
          do if (((R = v.next(E)), R && ((s[r++] = C(new d.Range(y, R.index + 1 + _, y, R.index + 1 + R[0].length + _), R, l)), r >= p))) return r;
          while (R);
          return r;
        }
        static findNextMatch(w, E, y, _) {
          ...
          return r.regex.multiline ? this._doFindNextMatchMultiline(w, y, s, _) : this._doFindNextMatchLineByLine(w, y, s, _);
        }
...
`
        ...
        static findPreviousMatch(w, E, y, _) {
          ...
          if (!r) return null;
          const s = new f(r.wordSeparators, r.regex);
          return r.regex.multiline ? this._doFindPreviousMatchMultiline(w, y, s, _) : this._doFindPreviousMatchLineByLine(w, y, s, _);
        }
        static _doFindPreviousMatchMultiline(w, E, y, _) {
          const r = this._doFindMatchesMultiline(w, new d.Range(1, 1, E.lineNumber, E.column), y, _, 10 * L);
        ...
        static _findLastMatchInLine(w, E, y, _) {
          let r = null,
            s;
          for (w.reset(0); (s = w.next(E)); ) r = C(new d.Range(y, s.index + 1, y, s.index + 1 + s[0].length), s, _);
          return r;
        }
      }
      n.TextModelSearch = a;
      ...
      class f {
        ...
        next(w) {
          ...
          let y;
          do {
            if (this._prevMatchStartIndex + this._prevMatchLength === E || ((y = this._searchRegex.exec(w)), !y)) return null;
            const _ = y.index,
              r = y[0].length;
            ...
            if (((this._prevMatchStartIndex = _), (this._prevMatchLength = r), !this._wordSeparators || m(this._wordSeparators, w, E, _, r)))
              return y;
          } while (y);
          return null;
        }
    ...
    X(J[57], Z([0, 1, 2, 56, 6, 12, 28]), function (q, n, M, A, i, d, g) {
      ...
      class L {
        static computeUnicodeHighlights(a, u, c) {
          ...
          let E;
          w === 'allNonBasicAscii' ? (E = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g')) : (E = new RegExp(`${h(Array.from(w))}`, 'g'));
          ...
          return {ranges: _, hasMore: r, ambiguousCharacterCount: l, invisibleCharacterCount: p, nonBasicAsciiCharacterCount: b};
        }
      ...
      class o {
        ...
        getCandidateCodePoints() {
          ...
          const a = new Set();
          if (this.options.invisibleCharacters) for (const u of i.InvisibleCharacters.codePoints) C(String.fromCodePoint(u)) || a.add(u);
          if (this.options.ambiguousCharacters) for (const u of this.ambiguousCharacters.getConfusableCodePoints()) a.add(u);
          ...
          if (u)
            for (const S of u) {
              const w = S.codePointAt(0),
                E = i.isBasicASCII(S);
              (m = m || E), !E && !this.ambiguousCharacters.isAmbiguous(w) && !i.InvisibleCharacters.isInvisibleCharacter(w) && (f = !0);
            }
          return !m && f
            ? 0
            : this.options.invisibleCharacters && !C(a) && i.InvisibleCharacters.isInvisibleCharacter(c)
            ? 2
...
` ||
    ...
    X(J[59], Z([0, 1, 9, 13]), function (q, n, M, A) {
      ...
      class i {
        ...
        register(L, h) {
          return (
            ...
            this.handleChange([L]),
            (0, A.toDisposable)(() => {
              this._tokenizationSupports.get(L) === h && (this._tokenizationSupports.delete(L), this.handleChange([L]));
            })
          );
        }
        get(L) {
        ...
        setColorMap(L) {
          (this._colorMap = L), this._onDidChange.fire({changedLanguages: Array.from(this._tokenizationSupports.keys()), changedColorMap: !0});
        }
        getColorMap() {
      ...
      class d extends A.Disposable {
        ...
        async _create() {
          ...
          (this._isResolved = !0), L && !this._isDisposed && this._register(this._registry.register(this._languageId, L));
        }
      }
    }),
    ...
    X(J[17], Z([0, 1, 60]), function (q, n, M) {
      ...
      const E = globalThis;
      let y;
      typeof E.vscode < 'u' && typeof E.vscode.process < 'u' ? (y = E.vscode.process) : typeof process < 'u' && (y = process);
      const _ = typeof ((A = y?.versions) === null || A === void 0 ? void 0 : A.electron) == 'string',
        r = _ && y?.type === 'renderer';
    ...
    X(J[63], Z([0, 1, 62]), function (q, n, M) {
      ...
      class a extends Error {
        constructor(s, l, p) {
          let b;
          typeof l == 'string' && l.indexOf('not ') === 0 ? ((b = 'must not be'), (l = l.replace(/^not /, ''))) : (b = 'must be');
      ...
      function E(r, s, l, p) {
        ...
        for (let x = 0; x <= r.length; ++x) {
          ...
          if (p(D)) {
            if (!(R === x - 1 || N === 1))
              if (N === 2) {
                if (b.length < 2 || v !== 2 || b.charCodeAt(b.length - 1) !== L || b.charCodeAt(b.length - 2) !== L) {
                  if (b.length > 2) {
                    const T = b.lastIndexOf(l);
                    T === -1 ? ((b = ''), (v = 0)) : ((b = b.slice(0, T)), (v = b.length - 1 - b.lastIndexOf(l))), (R = x), (N = 0);
                    continue;
                  } else if (b.length !== 0) {
                    (b = ''), (v = 0), (R = x), (N = 0);
                    continue;
              ...
              } else b.length > 0 ? (b += `${l}${r.slice(R + 1, x)}`) : (b = r.slice(R + 1, x)), (v = x - R - 1);
            (R = x), (N = 0);
          } else D === L && N !== -1 ? ++N : (N = -1);
        }
        return b;
      ...
      n.win32 = {
          ...
          for (let b = r.length - 1; b >= -1; b--) {
            ...
            if (b >= 0) {
              ...
              s.length === 0
                ? (v = M.cwd())
                : ((v = M.env[`=${s}`] || M.cwd()),
                  (v === void 0 || (v.slice(0, 2).toLowerCase() !== s.toLowerCase() && v.charCodeAt(2) === o)) && (v = `${s}\\`));
            const R = v.length;
            let N = 0,
              D = '',
              x = !1;
            ...
            else w(T) && v.charCodeAt(1) === C && ((D = v.slice(0, 2)), (N = 2), R > 2 && f(v.charCodeAt(2)) && ((x = !0), (N = 3)));
            if (D.length > 0)
              if (s.length > 0) {
        ...
        normalize(r) {
          ...
          else w(v) && r.charCodeAt(1) === C && ((p = r.slice(0, 2)), (l = 2), s > 2 && f(r.charCodeAt(2)) && ((b = !0), (l = 3)));
        ...
        relative(r, s) {
          ...
          if (U !== T) {
            ...
            R > T && (r.charCodeAt(b + U) === o ? (F = U) : U === 2 && (F = 3)), F === -1 && (F = 0);
          }
          let z = '';
          for (U = b + F + 1; U <= v; ++U) (U === v || r.charCodeAt(U) === o) && (z += z.length === 0 ? '..' : '\\..');
          return (N += F), z.length > 0 ? `${z}${p.slice(N, D)}` : (p.charCodeAt(N) === o && ++N, p.slice(N, D));
        },
        toNamespacedPath(r) {
          ...
          } else if (w(s.charCodeAt(0)) && s.charCodeAt(1) === C && s.charCodeAt(2) === o) return `\\\\?\\${s}`;
          return r;
        },
        dirname(r) {
          c(r, 'path');
          ...
          } else w(b) && r.charCodeAt(1) === C && ((l = s > 2 && f(r.charCodeAt(2)) ? 3 : 2), (p = l));
          let v = -1,
            R = !0;
          for (let N = s - 1; N >= p; --N)
            if (f(r.charCodeAt(N))) {
        ...
        basename(r, s) {
          ...
          let l = 0,
            ...
            b = !0,
            v;
          if ((r.length >= 2 && w(r.charCodeAt(0)) && r.charCodeAt(1) === C && (l = 2), s !== void 0 && s.length > 0 && s.length <= r.length)) {
            if (s === r) return '';
            let R = s.length - 1,
              N = -1;
            for (v = r.length - 1; v >= l; --v) {
              ...
              } else N === -1 && ((b = !1), (N = v + 1)), R >= 0 && (D === s.charCodeAt(R) ? --R === -1 && (p = v) : ((R = -1), (p = N)));
            }
        ...
        extname(r) {
          ...
          for (let N = r.length - 1; N >= s; --N) {
            ...
            b === -1 && ((v = !1), (b = N + 1)), D === L ? (l === -1 ? (l = N) : R !== 1 && (R = 1)) : l !== -1 && (R = -1);
          }
          return l === -1 || b === -1 || R === 0 || (R === 1 && l === b - 1 && l === p + 1) ? '' : r.slice(l, b);
        },
        format: y.bind(null, '\\'),
        parse(r) {
          c(r, 'path');
          ...
          for (; x >= p; --x) {
            ...
            N === -1 && ((D = !1), (N = x + 1)), b === L ? (v === -1 ? (v = x) : T !== 1 && (T = 1)) : v !== -1 && (T = -1);
          }
          return (
            N !== -1 &&
      ...
      (n.posix = {
        ...
        normalize(r) {
          ...
          return (r = E(r, !s, '/', S)), r.length === 0 ? (s ? '/' : l ? './' : '.') : (l && (r += '/'), s ? `/${r}` : r);
        },
        isAbsolute(r) {
        ...
        relative(r, s) {
          if ((c(r, 'from'), c(s, 'to'), r === s || ((r = n.posix.resolve(r)), (s = n.posix.resolve(s)), r === s))) return '';
          const l = 1,
            p = r.length,
            b = p - l,
            v = 1,
          ...
          let T = '';
          for (x = l + D + 1; x <= p; ++x) (x === p || r.charCodeAt(x) === h) && (T += T.length === 0 ? '..' : '/..');
        ...
        extname(r) {
          ...
          for (let R = r.length - 1; R >= 0; --R) {
            ...
            p === -1 && ((b = !1), (p = R + 1)), N === L ? (s === -1 ? (s = R) : v !== 1 && (v = 1)) : s !== -1 && (v = -1);
          }
          return s === -1 || p === -1 || v === 0 || (v === 1 && s === p - 1 && s === l + 1) ? '' : r.slice(s, p);
        },
        format: y.bind(null, '/'),
        parse(r) {
          c(r, 'path');
          ...
          for (; D >= p; --D) {
            ...
            R === -1 && ((N = !1), (R = D + 1)), T === L ? (b === -1 ? (b = D) : x !== 1 && (x = 1)) : b !== -1 && (x = -1);
          }
          if (R !== -1) {
            const T = v === 0 && l ? 1 : v;
    ...
    X(J[18], Z([0, 1, 63, 17]), function (q, n, M, A) {
      ...
      class u {
        ...
        with(p) {
          ...
          return (
            ...
            b === this.scheme && v === this.authority && R === this.path && N === this.query && D === this.fragment ? this : new m(b, v, R, N, D)
          );
        }
        static parse(p, b = !1) {
          const v = a.exec(p);
          return v ? new m(v[2] || C, s(v[4] || C), s(v[5] || C), s(v[7] || C), s(v[9] || C), b) : new m(C, C, C, C, C);
        }
        static file(p) {
          let b = C;
          if ((A.isWindows && (p = p.replace(/\\/g, e)), p[0] === e && p[1] === e)) {
            const v = p.indexOf(e, 2);
            v === -1 ? ((b = p.substring(2)), (p = e)) : ((b = p.substring(2, v)), (p = p.substring(v) || e));
          }
        ...
        static joinPath(p, ...b) {
          ...
          let v;
          return (
            A.isWindows && p.scheme === 'file' ? (v = u.file(M.win32.join(E(p, !0), ...b)).path) : (v = M.posix.join(p.path, ...b)), p.with({path: v})
          );
        }
        toString(p = !1) {
          return y(this, p);
      ...
      class m extends u {
        ...
        toString(p = !1) {
          return p ? y(this, !0) : (this._formatted || (this._formatted = y(this, !1)), this._formatted);
        }
        toJSON() {
          const p = {$mid: 1};
          return (
      ...
      function S(l, p, b) {
        ...
        for (let N = 0; N < l.length; N++) {
          ...
          if (
            ...
            const x = f[D];
            x !== void 0 ? (R !== -1 && ((v += encodeURIComponent(l.substring(R, N))), (R = -1)), (v += x)) : R === -1 && (R = N);
          }
        }
      ...
      function w(l) {
        ...
        for (let b = 0; b < l.length; b++) {
          ...
          v === 35 || v === 63 ? (p === void 0 && (p = l.substr(0, b)), (p += f[v])) : p !== void 0 && (p += l[b]);
        }
        return p !== void 0 ? p : l;
      }
      function E(l, p) {
        ...
        return (
          l.authority && l.path.length > 1 && l.scheme === 'file'
            ...
            : l.path.charCodeAt(0) === 47 &&
              ((l.path.charCodeAt(1) >= 65 && l.path.charCodeAt(1) <= 90) || (l.path.charCodeAt(1) >= 97 && l.path.charCodeAt(1) <= 122)) &&
      ...
      function y(l, p) {
        ...
        if ((R && ((v += R), (v += ':')), (N || R === 'file') && ((v += e), (v += e)), N)) {
          ...
          if (F !== -1) {
            ...
            (N = N.substr(F + 1)),
              (F = U.lastIndexOf(':')),
              F === -1 ? (v += b(U, !1, !1)) : ((v += b(U.substr(0, F), !1, !1)), (v += ':'), (v += b(U.substr(F + 1), !1, !0))),
              (v += '@');
          }
          (N = N.toLowerCase()), (F = N.lastIndexOf(':')), F === -1 ? (v += b(N, !1, !0)) : ((v += b(N.substr(0, F), !1, !0)), (v += N.substr(F)));
        }
        if (D) {
        ...
        return x && ((v += '?'), (v += b(x, !1, !1))), T && ((v += '#'), (v += p ? T : S(T, !1, !1))), v;
      }
      function _(l) {
        try {
    ...
    X(J[67], Z([0, 1, 5, 9, 13, 14, 17, 6]), function (q, n, M, A, i, d, g, L) {
      ...
      class e {
        constructor(l, p, b, v) {
          (this.vsWorker = l), (this.req = p), (this.method = b), (this.args = v), (this.type = 0);
        }
      }
      class a {
        constructor(l, p, b, v) {
      ...
      class u {
        constructor(l, p, b, v) {
          (this.vsWorker = l), (this.req = p), (this.eventName = b), (this.arg = v), (this.type = 2);
        }
      }
      class c {
        constructor(l, p, b) {
      ...
      class f {
        ...
        sendMessage(l, p) {
          ...
          return new Promise((v, R) => {
            (this._pendingReplies[b] = {resolve: v, reject: R}), this._send(new e(this._workerId, b, l, p));
          });
        }
        listen(l, p) {
          let b = null;
          const v = new A.Emitter({
            onWillAddFirstListener: () => {
              (b = String(++this._lastSentReq)), this._pendingEmitters.set(b, v), this._send(new u(this._workerId, b, l, p));
            },
            onDidRemoveLastListener: () => {
        ...
        _handleReplyMessage(l) {
          ...
          if ((delete this._pendingReplies[l.seq], l.err)) {
            let b = l.err;
            l.err.$isError && ((b = new Error()), (b.name = l.err.name), (b.message = l.err.message), (b.stack = l.err.stack)), p.reject(b);
            return;
          }
          p.resolve(l.res);
        }
          ...
          this._handler.handleMessage(l.method, l.args).then(
            ...
            (v) => {
              v.detail instanceof Error && (v.detail = (0, M.transformErrorForSerialization)(v.detail)),
                this._send(new a(this._workerId, p, void 0, (0, M.transformErrorForSerialization)(v)));
            }
          );
        }
        ...
        _send(l) {
          const p = [];
          if (l.type === 0) for (let b = 0; b < l.args.length; b++) l.args[b] instanceof ArrayBuffer && p.push(l.args[b]);
        ...
        constructor(l, p, b) {
          ...
          (this._worker = this._register(
            ...
            (this._protocol = new f({
              ...
              handleMessage: (F, U) => {
                if (typeof b[F] != 'function') return Promise.reject(new Error('Missing method ' + F + ' on main thread host.'));
                try {
              ...
              handleEvent: (F, U) => {
                if (E(F)) {
                  ...
                  if (typeof z != 'function') throw new Error(`Missing dynamic event ${F} on main thread host.`);
                  return z;
                }
                if (w(F)) {
                  const z = b[F];
                  if (typeof z != 'function') throw new Error(`Missing event ${F} on main thread host.`);
                  return z;
                }
          ...
          this._onModuleLoaded = this._protocol.sendMessage(h, [this._worker.getId(), JSON.parse(JSON.stringify(R)), p, D]);
      ...
      class _ {
        ...
        _handleEvent(l, p) {
          ...
          if (E(l)) {
            ...
            if (typeof b != 'function') throw new Error(`Missing dynamic event ${l} on request handler.`);
            return b;
          }
          if (w(l)) {
        ...
        initialize(l, p, b, v) {
          ...
          return this._requestHandlerFactory
            ? ((this._requestHandler = this._requestHandlerFactory(D)), Promise.resolve((0, d.getAllMethodNames)(this._requestHandler)))
            : (p &&
    ...
    X(J[65], Z([0, 1, 40, 18, 2, 59, 64]), function (q, n, M, A, i, d, g) {
      ...
      (function (s) {
        ...
        function p(b) {
          let v = l.get(b);
          return v || (console.info('No codicon found for SymbolKind ' + b), (v = M.Codicon.symbolProperty)), v;
        }
        s.toIcon = p;
      })(S || (n.SymbolKinds = S = {}));
      class w {}
      ...
      (n.FoldingRangeKind = E), (E.Comment = new E('comment')), (E.Imports = new E('imports')), (E.Region = new E('region'));
      var y;
      (function (s) {
        function l(p) {
          return !p || typeof p != 'object' ? !1 : typeof p.id == 'string' && typeof p.title == 'string';
        }
        s.is = l;
      })(y || (n.Command = y = {}));
      var _;
    ...
    X(J[66], Z([0, 1, 38, 9, 35, 18, 4, 2, 41, 65, 58]), function (q, n, M, A, i, d, g, L, h, o, C) {
      'use strict';
    ...
    X(J[68], Z([0, 1, 24, 18, 4, 2, 55, 28, 51, 52, 66, 23, 57, 49, 14, 50]), function (q, n, M, A, i, d, g, L, h, o, C, e, a, u, c, m) {
      'use strict';
      ...
      class f extends g.MirrorTextModel {
        ...
        getWordAtPosition(y, _) {
          const r = (0, L.getWordAtText)(y.column, (0, L.ensureValidWordDefinition)(_), this._lines[y.lineNumber - 1], 0);
        ...
        getLineWords(y, _) {
          const r = this._lines[y - 1],
            ...
            l = [];
          for (const p of s) l.push({word: r.substring(p.start, p.end), startColumn: p.start + 1, endColumn: p.end + 1});
          return l;
        }
        _wordenize(y, _) {
          const r = [];
          let s;
          for (_.lastIndex = 0; (s = _.exec(y)) && s[0].length !== 0; ) r.push({start: s.index, end: s.index + s[0].length});
          return r;
        }
        getValueInRange(y) {
          if (((y = this._validateRange(y)), y.startLineNumber === y.endLineNumber))
            return this._lines[y.startLineNumber - 1].substring(y.startColumn - 1, y.endColumn - 1);
          const _ = this._eol,
        ...
        offsetAt(y) {
          return (y = this._validatePosition(y)), this._ensureLineStarts(), this._lineStarts.getPrefixSum(y.lineNumber - 2) + (y.column - 1);
        }
        positionAt(y) {
        ...
        _validateRange(y) {
          const _ = this._validatePosition({lineNumber: y.startLineNumber, column: y.startColumn}),
            r = this._validatePosition({lineNumber: y.endLineNumber, column: y.endColumn});
          return _.lineNumber !== y.startLineNumber || _.column !== y.startColumn || r.lineNumber !== y.endLineNumber || r.column !== y.endColumn
            ? {startLineNumber: _.lineNumber, startColumn: _.column, endLineNumber: r.lineNumber, endColumn: r.column}
            : y;
        }
        _validatePosition(y) {
          ...
          let {lineNumber: _, column: r} = y,
            s = !1;
          if (_ < 1) (_ = 1), (r = 1), (s = !0);
          else if (_ > this._lines.length) (_ = this._lines.length), (r = this._lines[_ - 1].length + 1), (s = !0);
          else {
      ...
      class S {
        constructor(y, _) {
          (this._host = y), (this._models = Object.create(null)), (this._foreignModuleFactory = _), (this._foreignModule = null);
        }
        dispose() {
        ...
        async computeMoreMinimalEdits(y, _, r) {
          ...
          for (let v = 1; v < _.length; v++)
            d.Range.getEndPosition(_[b].range).equals(d.Range.getStartPosition(_[v].range))
              ? ((_[b].range = d.Range.fromPositions(d.Range.getStartPosition(_[b].range), d.Range.getEndPosition(_[v].range))),
                (_[b].text += _[v].text))
              : (b++, (_[b] = _[v]));
          _.length = b + 1;
            ...
            for (const F of x) {
              const U = s.positionAt(T + F.originalStart),
                ...
                k = {
                  ...
                  range: {startLineNumber: U.lineNumber, startColumn: U.column, endLineNumber: z.lineNumber, endColumn: z.column},
                };
              s.getValueInRange(k.range) !== k.text && l.push(k);
            }
          }
          return typeof p == 'number' && l.push({eol: p, text: '', range: {startLineNumber: 0, startColumn: 0, endLineNumber: 0, endColumn: 0}}), l;
        }
        ...
        async textualSuggest(y, _, r, s) {
          ...
          e: for (const v of y) {
            ...
            if (R) {
              for (const N of R.words(p)) if (!(N === _ || !isNaN(Number(N))) && (b.add(N), b.size > S._suggestionsLimit)) break e;
            }
          }
        ...
        async computeWordRanges(y, _, r, s) {
          ...
          for (let v = _.startLineNumber; v < _.endLineNumber; v++) {
            ...
            for (const N of R) {
              ...
              let D = b[N.word];
              D || ((D = []), (b[N.word] = D)), D.push({startLineNumber: v, startColumn: N.startColumn, endLineNumber: v, endColumn: N.endColumn});
            }
          }
          return b;
        }
        async navigateValueSet(y, _, r, s, l) {
          ...
          _.startColumn === _.endColumn &&
            (_ = {startLineNumber: _.startLineNumber, startColumn: _.startColumn, endLineNumber: _.endLineNumber, endColumn: _.endColumn + 1});
        ...
        loadForeignModule(y, _, r) {
          const s = (b, v) => this._host.fhr(b, v),
            p = {host: (0, c.createProxyObject)(r, s), getMirrorModels: () => this._getModels()};
          return this._foreignModuleFactory
            ? ((this._foreignModule = this._foreignModuleFactory(p, _)), Promise.resolve((0, c.getAllMethodNames)(this._foreignModule)))
            : new Promise((b, v) => {
                q(
                  [y],
                  (R) => {
                    (this._foreignModule = R.create(p, _)), b((0, c.getAllMethodNames)(this._foreignModule));
                  },
                  v
                );
              });
      ...
      (n.create = w), typeof importScripts == 'function' && (globalThis.monaco = (0, C.createMonacoBaseAPI)());
    });
}).call(this);
